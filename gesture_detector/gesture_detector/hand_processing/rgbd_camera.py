...
def main():
    ...
    rosnode.create_subscription(Image, 'something as /camera/color_raw', recieve_color_camera_image, 5)
    rosnode.create_subscription(Image, 'something as /camera/depth_raw', recieve_depth_camera_image, 5)
    ...
    def recieve_color_camera_image(msg):
        
    def recieve_depth_camera_image(msg):
